...
app.post('/register', encodeUrl, (req, res) => {
    ...
    con.connect(function(err) {
		...
		con.query("SELECT * FROM myform.users WHERE username = ? AND password  = ?",[userName,password], function(err, result){ if(err){
                console.log(err);
            };
            ...
            function userPage(){
                ...
                var sql = "INSERT INTO myform.users (firstname, lastname, username, password) VALUES (?,?,?,?)";
                con.query(sql,[firstName,lastName,userName,password], function (err, result,fields) {
                    if (err){
                        console.log(err);
                    }else{
